...
head -1 ${CURRENT_DATA}/contacts.csv > ${CURRENT_DATA}/contacts.csv
...
head -1 ${CURRENT_DATA}/messages.csv > ${CURRENT_DATA}/messages.csv
...
head -1 ${CURRENT_DATA}/flows.csv > ${CURRENT_DATA}/flows.csv
...
head -1 ${CURRENT_DATA}/runs.csv > ${CURRENT_DATA}/runs.csv
